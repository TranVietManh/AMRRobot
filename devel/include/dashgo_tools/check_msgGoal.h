...
struct check_msgGoal_
{
  ...
  _method_type method;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _imu_type;
  _imu_type imu;
...
bool operator==(const ::dashgo_tools::check_msgGoal_<ContainerAllocator1> & lhs, const ::dashgo_tools::check_msgGoal_<ContainerAllocator2> & rhs)
{
...
struct Printer< ::dashgo_tools::check_msgGoal_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dashgo_tools::check_msgGoal_<ContainerAllocator>& v)
  {
    ...
    s << indent << "imu: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.imu);
    s << indent << "distance: ";
