...
class check_msgActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new check_msgFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = check_msgFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new check_msgActionFeedback(null);
    ...
    data.feedback = check_msgFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new check_msgActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = check_msgFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new check_msgFeedback()
    }
...
module.exports = check_msgActionFeedback;
