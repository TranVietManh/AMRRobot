...
class check_msgActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = check_msgGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += check_msgGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new check_msgActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = check_msgGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new check_msgGoal()
    }
...
module.exports = check_msgActionGoal;
